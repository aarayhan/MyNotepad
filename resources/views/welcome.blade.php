<x-layouts.app title="MyNotepad">
    <section class="grid gap-8 py-6 md:grid-cols-[1.05fr_0.95fr] md:items-center md:py-12">
        <div>
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="{{ route('register') }}" class="rounded-md bg-zinc-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-zinc-800">
                    Start writing
                </a>
                <a href="{{ route('login') }}" class="rounded-md border border-zinc-300 px-5 py-2.5 text-center text-sm font-medium text-zinc-700 hover:bg-zinc-100">
                    Login
                </a>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-5">
            <div class="mb-5 flex items-center justify-between border-b border-zinc-200 pb-4">
                ...
                <span class="rounded-md border border-zinc-200 px-2.5 py-1 text-xs text-zinc-600">2 notes</span>
            </div>
            ...
            <div class="mt-5 rounded-lg border border-dashed border-zinc-300 p-4 text-sm text-zinc-600">
    ...
    <section class="mt-8 rounded-xl border border-zinc-200 bg-white p-6 text-center sm:p-8">
        ...
        <a href="{{ route('register') }}" class="mt-6 inline-block rounded-md bg-zinc-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-zinc-800">
            Create Account
        </a>
    </section>
</x-layouts.app>
